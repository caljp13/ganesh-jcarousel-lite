...
(function($){
	...
	$.jCarouselLite = function(elem,o) {
		...
		exec = function(){
			...
			$this.css(sizeCss, divSize+"px");

			if(o.btnPrev)
				$(o.btnPrev).bind("click.carousel",function() {
					return go(curr-o.scroll);
				});

			if(o.btnNext)
				$(o.btnNext).bind("click.carousel",function() {
					return go(curr+o.scroll);
				});

			if(o.btnGo)
				$.each(o.btnGo, function(i, val) {
					$(val).bind("click.carousel",function() {
			...
			if(o.auto)
				setInterval(function(){
					// verifica se o mouse esta sobre o carrossel e caso esteja não vai para a próxima
					if(!isMouseOver)
						go(curr+o.scroll);
				}, o.auto+o.speed);
			
			// Informa que o mouse esta sobre o carrossel e que ele deve parar
			if(o.pauseHover)
				$this.bind({
